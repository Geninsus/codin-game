var data = {
  ...
  levels  : [
    ...
    {
      wording : 'Le but de cet exercice est de faire la somme des nombres entre 1 et le nombre en entrée. Par exemple si l\'entrée vaut 3, la sortie doit valoir 3 + 2 + 1 donc 6.',
      commands : ['inbox', 'outbox'],
